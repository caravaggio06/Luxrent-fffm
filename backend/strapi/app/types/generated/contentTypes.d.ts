...
export interface ApiCarCar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    accelTo100: Schema.Attribute.Decimal;
    brand: Schema.Attribute.String & Schema.Attribute.Required;
    consumptionL100: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dailyPrice: Schema.Attribute.Integer;
    deposit: Schema.Attribute.Integer;
    drivetrain: Schema.Attribute.String;
    gearbox: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    powerHp: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    topspeedKmh: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    weekendPrice: Schema.Attribute.Integer;
